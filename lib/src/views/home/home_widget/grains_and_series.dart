...
import '../../view_all_screen/view_all_grains_and_cereals_screen.dart';

class GrainsAndCereals extends StatelessWidget {
        ...
        SectionTitle(
          ...
          onTap: () {
            final route = MaterialPageRoute(
                builder: (context) => ViewAllGrainsAndCerealsScreen());
